var games = {
  ...
  'la': {
    ...
    'offset': 0,
    'splits': [
      { id: 'tailkey', name: 'Tail Key', },
      { id: 'd1', name: 'Tail Cave', },
      { id: 'bracelet', name: 'Power Bracelet', },
      { id: 'd3', name: 'Key Cavern', },
      { id: 'animalwarp', name: 'Animal Warp', },
      { id: 'd4', name: 'Angler\'s Tunnel', },
      { id: 'rooster', name: 'Rooster Skip Skip', },
      { id: 'd7', name: 'Eagle\'s Tower', },
      { id: 'd8warp', name: 'Mountain Warp', },
      { id: 'facekey', name: 'Face Key', },
